...
#   - https://hub.docker.com/_/debian?tab=tags&page=1&name=bullseye-20251020-slim - for the release image
...
RUN . $HOME/.nvm/nvm.sh && cd assets && yarn install && yarn deploy
...
RUN apt-get update -y && \
  apt-get install -y libstdc++6 openssl libncurses5 locales ca-certificates curl imagemagick wget \
  && apt-get clean && rm -f /var/lib/apt/lists/*_*
