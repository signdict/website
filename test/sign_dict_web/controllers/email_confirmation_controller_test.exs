defmodule SignDictWeb.EmailConfirmationControllerTest do
  ...
  describe "update/2" do
      ...
      conn =
        ...
        |> get(
          email_confirmation_path(
            ...
            confirmation_token: "encryptedtoken"
          )
        )
    ...
    test "it signs in the user and confirms the email address and redirects to the landing page if it was just a change",
         %{conn: conn} do
      insert(
        :user,
        unconfirmed_email: "confirm-3@example.com",
